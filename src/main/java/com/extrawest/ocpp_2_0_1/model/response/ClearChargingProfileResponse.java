...
public class ClearChargingProfileResponse extends Confirmation {
     ...
     */
    @JsonProperty("status")
    public ClearChargingProfileStatusEnumType status;
    /**
    ...
    public ClearChargingProfileResponse(ClearChargingProfileStatusEnumType status) {
    ...
    public void setStatus(ClearChargingProfileStatusEnumType status) {
        requiredValidator.validate(status);
        this.status = status;
    }
