...
public class SetNetworkProfileResponse extends Confirmation {
     ...
     */
    @JsonProperty("status")
    public SetNetworkProfileStatusEnumType status;
    /**
    ...
    public SetNetworkProfileResponse(SetNetworkProfileStatusEnumType status) {
    ...
    public void setStatus(SetNetworkProfileStatusEnumType status) {
        requiredValidator.validate(status);
        this.status = status;
    }
