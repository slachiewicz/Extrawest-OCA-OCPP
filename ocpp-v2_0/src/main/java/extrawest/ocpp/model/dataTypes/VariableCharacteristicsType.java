...
import com.extrawest.ocpp_2_0_1.model.dataTypes.enums.DataEnumType;
...
public class VariableCharacteristicsType implements Validatable {
    ...
    private final transient Validator valuesListValidator =
            new ValidatorBuilder().addRule(OCPP2PrimDatatypes.string1000()).build();

    private final transient Validator unitValidator =
