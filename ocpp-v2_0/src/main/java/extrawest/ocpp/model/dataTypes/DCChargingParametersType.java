...
import com.extrawest.common.model.validation.IntegerBetweenZeroAndOneHundred;
...
public class DCChargingParametersType implements Validatable {
    ...
    private final transient Validator<Integer> intBetweenZeroAndOneHundredValidator = new IntegerBetweenZeroAndOneHundred();
