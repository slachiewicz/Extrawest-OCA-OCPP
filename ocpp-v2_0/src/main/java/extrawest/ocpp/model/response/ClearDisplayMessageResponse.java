...
public class ClearDisplayMessageResponse extends Confirmation {
     ...
     */
    @JsonProperty("status")
    public ClearMessageStatusEnumType status;
    /**
    ...
    public ClearDisplayMessageResponse(ClearMessageStatusEnumType status) {
    ...
    public void setStatus(ClearMessageStatusEnumType status) {
        requiredValidator.validate(status);
        this.status = status;
    }
